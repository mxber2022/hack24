...
contract ProgrammableTokenTransfers is CCIPReceiver, OwnerIsCreator {
    ...
    function sendMessagePayLINK(uint64 _destinationChainSelector, address _receiver, string calldata _text, address _token, uint256 _amount)
        ...
        )
    {
        ...
        if (keccak256(abi.encodePacked(receivedText)) == keccak256(abi.encodePacked("yes"))){
